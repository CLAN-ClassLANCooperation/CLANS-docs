...
heroText: CLANC 系列产品
tagline: 由 CLANC 团队呈献，100% 开源免费。
actions:
  - text: CLAND 教室端 部署指南
    icon: download
    link: /CLANDCRSide/install
    type: primary

  - text: CLAND 教师端 部署指南
    link: /CLANDTSide/install
...
highlights:
  - header: 易于使用，现代支持
    ...
    highlights:
      - title: 傻瓜式部署，一看就会
      - title: 支持 <code>Windows 10/11</code>

  - header: Introducing OpenTalk
    description: 也许是重新定义了校园内网协作
    ...
    features:
      - title: 100% 内网部署
        ...
        details: 不再依赖互联网，校园网环境不稳定时也可放心使用
...
copyright: false
footer: 本文档使用 <a href="https://theme-hope.vuejs.press/zh/" target="_blank">VuePress Theme Hope</a> 主题 | MIT 协议, 版权所有 © 2025 CLANC 团队。
